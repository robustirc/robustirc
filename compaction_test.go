...
func TestCompactSessionDeleteJoinAway(t *testing.T) {
	ircServer = ircserver.NewIRCServer("", "testnetwork", time.Now())
	ircServer.Config.Operators = append(ircServer.Config.Operators, config.IRCOp{
		Name:     "foo",
		Password: "bar",
	...
	input := []string{
		...
		`{"Id": {"Id": 3}, "Session": {"Id": 1}, "Type": 2, "Data": "USER blah 0 * :Michael Stapelberg"}`,
		`{"Id": {"Id": 4}, "Session": {"Id": 1}, "Type": 2, "Data": "OPER foo bar"}`,
		`{"Id": {"Id": 5}, "Session": {"Id": 1}, "Type": 2, "Data": "JOIN #test"}`,
		`{"Id": {"Id": 6}, "Session": {"Id": 1}, "Type": 2, "Data": "AWAY :bleh"}`,
		`{"Id": {"Id": 7}, "Session": {"Id": 1}, "Type": 2, "Data": "KILL secure :bye"}`,
	}
	want := []string{}
...
func TestCompactSessionDeleteJoinKill(t *testing.T) {
	ircServer = ircserver.NewIRCServer("", "testnetwork", time.Now())
	ircServer.Config.Operators = append(ircServer.Config.Operators, config.IRCOp{
		Name:     "foo",
		Password: "bar",
	...
	input := []string{
		...
		`{"Id": {"Id": 4}, "Session": {"Id": 1}, "Type": 2, "Data": "OPER foo bar"}`,
		`{"Id": {"Id": 5}, "Session": {"Id": 1}, "Type": 2, "Data": "JOIN #test"}`,
		`{"Id": {"Id": 6}, "Session": {"Id": 1}, "Type": 2, "Data": "KILL secure :bye"}`,
	}
	want := []string{}
...
func TestCompactSessionDeleteJoinSvsmodeKill(t *testing.T) {
	ircServer = ircserver.NewIRCServer("", "testnetwork", time.Now())
	...
	input := []string{
		...
		`{"Id": {"Id": 7}, "Session": {"Id": 4}, "Type": 2, "Data": "NICK NickServ 1 1422134861 services robustirc.net services.robustirc.net 0 :Nick Server"}`,
		`{"Id": {"Id": 8}, "Session": {"Id": 1}, "Type": 2, "Data": "JOIN #test"}`,
		`{"Id": {"Id": 9}, "Session": {"Id": 4}, "Type": 2, "Data": ":NickServ SVSMODE sECuRE +d 0"}`,
		`{"Id": {"Id": 10}, "Session": {"Id": 4}, "Type": 2, "Data": ":services.robustirc.net KILL sECuRE :Nick collision"}`,
	}
	want := []string{
		`{"Id": {"Id": 4}, "Type": 0, "Data": "auth"}`,
		`{"Id": {"Id": 5}, "Session": {"Id": 4}, "Type": 2, "Data": "PASS :services=mypass"}`,
