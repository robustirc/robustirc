...
func TestQuit(t *testing.T) {
	...
	mustMatchIrcmsgs(t,
		i.ProcessMessage(&robust.Message{Session: ids["secure"]}, irc.ParseMessage("quit :bye bye")),
		[]*irc.Message{
	...
	i.ProcessMessage(&robust.Message{Session: ids["xeen"]}, irc.ParseMessage("part #test"))
