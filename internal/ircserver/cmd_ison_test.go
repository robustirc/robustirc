...
func TestIson(t *testing.T) {
	...
	mustMatchMsg(t,
		i.ProcessMessage(&robust.Message{Session: ids["xeen"]}, irc.ParseMessage("ISON")),
		":robustirc.net 461 xeen ISON :Not enough parameters")

	mustMatchMsg(t,
		i.ProcessMessage(&robust.Message{Session: ids["xeen"]}, irc.ParseMessage("ISON mero sECuRE nope")),
